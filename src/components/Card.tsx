  ...
  return (
    <div className="card_box font-poppins border border-solid border-gray-200 shadow-md  bg-white overflow-hidden flex flex-col">
      <div className="flex flex-col py-5">
        <h2 className="my-0.5 text-xl sm:text-2xl px-3 sm:px-5 text-gray-800 font-medium ">
          {data.itemName}
        </h2>
        <p className="text-gray-500 px-3 sm:px-5 sm:text-base text-sm">{data.itemDesc}</p>
      </div>
      <div className="flex mt-auto">
        <button
          className="border border-solid border-gray-200 text-gray-500 py-2 w-1/2 place-content-center flex gap-2 sm:text-base text-sm"
